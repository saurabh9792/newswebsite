...
<body>
<!-- HEADER -->
<div id="header" style="background-color:rgba(255, 99, 71, 1);">
    <!-- container -->
    <div class="container">
        <!-- row -->
        <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
             ...
             $result=mysqli_query($conn,$sql) or die("Query is unsucessful : category ");
             ...
             ?>
                ...
                <ul class='menu'>
                <li><a href='http://localhost:70/news-website/index.php'>Home</a></li>
                <?php
                while($row=mysqli_fetch_assoc($result))
                {
                    if(isset($_GET["cid"]))
